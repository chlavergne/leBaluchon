...
//  leBaluchon
//
//  Created by Christophe Expleo on 11/09/2021.
//
...
class CountryNames {
    let codeToCountry = [
      ...
      "ARS": "Argentina",
      "AUD": """
                Australia, Australian Antarctic Territory, Christmas Island, Cocos (Keeling) Islands,
                Heard and McDonald Islands, Kiribati, Nauru, Norfolk Island, Tuvalu
            """,
      "AWG": "Aruba",
      "AZN": "Azerbaijan",
      ...
      "UGX": "Uganda",
      "USD": """
            American Samoa, British Indian Ocean Territory, Ecuador, El Salvador, Guam, Haiti, Marshall Islands,
            Micronesia, Northern Mariana Islands, Palau, Panama, Puerto Rico, East Timor, Turks and Caicos Islands,
            United States, Virgin Ilands
            """,
      "USN": "United States",
      "USS": "United States",
      "UYU": "Uruguay",
